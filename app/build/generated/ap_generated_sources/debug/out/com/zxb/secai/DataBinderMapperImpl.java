...
import com.zxb.secai.databinding.ActivityFeedDetailTypeImageBindingImpl;
import com.zxb.secai.databinding.ActivityLayoutCaptureBindingImpl;
import com.zxb.secai.databinding.ActivityLayoutPreviewBindingImpl;
import com.zxb.secai.databinding.ActivityLayoutProfileBindingImpl;
import com.zxb.secai.databinding.ActivityLayoutPublishBindingImpl;
import com.zxb.secai.databinding.ActivityLayoutTagFeedListBindingImpl;
import com.zxb.secai.databinding.FragmentMyBindingImpl;
import com.zxb.secai.databinding.FragmentSofaBindingImpl;
import com.zxb.secai.databinding.LayoutCommentDialogBindingImpl;
import com.zxb.secai.databinding.LayoutFeedAuthorBindingImpl;
import com.zxb.secai.databinding.LayoutFeedCommentListItemBindingImpl;
import com.zxb.secai.databinding.LayoutFeedDetailAuthorInfoBindingImpl;
import com.zxb.secai.databinding.LayoutFeedDetailBottomInateractionBindingImpl;
import com.zxb.secai.databinding.LayoutFeedDetailTypeImageHeaderBindingImpl;
import com.zxb.secai.databinding.LayoutFeedDetailTypeVideoBindingImpl;
import com.zxb.secai.databinding.LayoutFeedDetailTypeVideoHeaderBindingImpl;
import com.zxb.secai.databinding.LayoutFeedInteractionBindingImpl;
import com.zxb.secai.databinding.LayoutFeedTagBindingImpl;
import com.zxb.secai.databinding.LayoutFeedTextBindingImpl;
import com.zxb.secai.databinding.LayoutFeedTopCommentBindingImpl;
import com.zxb.secai.databinding.LayoutFeedTypeCommentBindingImpl;
import com.zxb.secai.databinding.LayoutFeedTypeImageBindingImpl;
import com.zxb.secai.databinding.LayoutFeedTypeVideoBindingImpl;
import com.zxb.secai.databinding.LayoutProfileTabCommentInteractionBindingImpl;
import com.zxb.secai.databinding.LayoutRefreshViewBindingImpl;
import com.zxb.secai.databinding.LayoutTagFeedListHeaderBindingImpl;
import com.zxb.secai.databinding.LayoutTagListItemBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  static {
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.activity_feed_detail_type_image, LAYOUT_ACTIVITYFEEDDETAILTYPEIMAGE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.activity_layout_capture, LAYOUT_ACTIVITYLAYOUTCAPTURE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.activity_layout_preview, LAYOUT_ACTIVITYLAYOUTPREVIEW);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.activity_layout_profile, LAYOUT_ACTIVITYLAYOUTPROFILE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.activity_layout_publish, LAYOUT_ACTIVITYLAYOUTPUBLISH);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.activity_layout_tag_feed_list, LAYOUT_ACTIVITYLAYOUTTAGFEEDLIST);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.fragment_my, LAYOUT_FRAGMENTMY);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.fragment_sofa, LAYOUT_FRAGMENTSOFA);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_comment_dialog, LAYOUT_LAYOUTCOMMENTDIALOG);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_feed_author, LAYOUT_LAYOUTFEEDAUTHOR);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_feed_comment_list_item, LAYOUT_LAYOUTFEEDCOMMENTLISTITEM);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_feed_detail_author_info, LAYOUT_LAYOUTFEEDDETAILAUTHORINFO);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_feed_detail_bottom_inateraction, LAYOUT_LAYOUTFEEDDETAILBOTTOMINATERACTION);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_feed_detail_type_image_header, LAYOUT_LAYOUTFEEDDETAILTYPEIMAGEHEADER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_feed_detail_type_video, LAYOUT_LAYOUTFEEDDETAILTYPEVIDEO);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_feed_detail_type_video_header, LAYOUT_LAYOUTFEEDDETAILTYPEVIDEOHEADER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_feed_interaction, LAYOUT_LAYOUTFEEDINTERACTION);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_feed_tag, LAYOUT_LAYOUTFEEDTAG);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_feed_text, LAYOUT_LAYOUTFEEDTEXT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_feed_top_comment, LAYOUT_LAYOUTFEEDTOPCOMMENT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_feed_type_comment, LAYOUT_LAYOUTFEEDTYPECOMMENT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_feed_type_image, LAYOUT_LAYOUTFEEDTYPEIMAGE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_feed_type_video, LAYOUT_LAYOUTFEEDTYPEVIDEO);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_profile_tab_comment_interaction, LAYOUT_LAYOUTPROFILETABCOMMENTINTERACTION);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_refresh_view, LAYOUT_LAYOUTREFRESHVIEW);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_tag_feed_list_header, LAYOUT_LAYOUTTAGFEEDLISTHEADER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.zxb.secai.R.layout.layout_tag_list_item, LAYOUT_LAYOUTTAGLISTITEM);
  }
  ...
  public List<DataBinderMapper> collectDependencies() {
    ...
    result.add(new com.zxb.libcommon.DataBinderMapperImpl());
    return result;
  }
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      sKeys.put("layout/activity_feed_detail_type_image_0", com.zxb.secai.R.layout.activity_feed_detail_type_image);
      sKeys.put("layout/activity_layout_capture_0", com.zxb.secai.R.layout.activity_layout_capture);
      sKeys.put("layout/activity_layout_preview_0", com.zxb.secai.R.layout.activity_layout_preview);
      sKeys.put("layout/activity_layout_profile_0", com.zxb.secai.R.layout.activity_layout_profile);
      sKeys.put("layout/activity_layout_publish_0", com.zxb.secai.R.layout.activity_layout_publish);
      sKeys.put("layout/activity_layout_tag_feed_list_0", com.zxb.secai.R.layout.activity_layout_tag_feed_list);
      sKeys.put("layout/fragment_my_0", com.zxb.secai.R.layout.fragment_my);
      sKeys.put("layout/fragment_sofa_0", com.zxb.secai.R.layout.fragment_sofa);
      sKeys.put("layout/layout_comment_dialog_0", com.zxb.secai.R.layout.layout_comment_dialog);
      sKeys.put("layout/layout_feed_author_0", com.zxb.secai.R.layout.layout_feed_author);
      sKeys.put("layout/layout_feed_comment_list_item_0", com.zxb.secai.R.layout.layout_feed_comment_list_item);
      sKeys.put("layout/layout_feed_detail_author_info_0", com.zxb.secai.R.layout.layout_feed_detail_author_info);
      sKeys.put("layout/layout_feed_detail_bottom_inateraction_0", com.zxb.secai.R.layout.layout_feed_detail_bottom_inateraction);
      sKeys.put("layout/layout_feed_detail_type_image_header_0", com.zxb.secai.R.layout.layout_feed_detail_type_image_header);
      sKeys.put("layout/layout_feed_detail_type_video_0", com.zxb.secai.R.layout.layout_feed_detail_type_video);
      sKeys.put("layout/layout_feed_detail_type_video_header_0", com.zxb.secai.R.layout.layout_feed_detail_type_video_header);
      sKeys.put("layout/layout_feed_interaction_0", com.zxb.secai.R.layout.layout_feed_interaction);
      sKeys.put("layout/layout_feed_tag_0", com.zxb.secai.R.layout.layout_feed_tag);
      sKeys.put("layout/layout_feed_text_0", com.zxb.secai.R.layout.layout_feed_text);
      sKeys.put("layout/layout_feed_top_comment_0", com.zxb.secai.R.layout.layout_feed_top_comment);
      sKeys.put("layout/layout_feed_type_comment_0", com.zxb.secai.R.layout.layout_feed_type_comment);
      sKeys.put("layout/layout_feed_type_image_0", com.zxb.secai.R.layout.layout_feed_type_image);
      sKeys.put("layout/layout_feed_type_video_0", com.zxb.secai.R.layout.layout_feed_type_video);
      sKeys.put("layout/layout_profile_tab_comment_interaction_0", com.zxb.secai.R.layout.layout_profile_tab_comment_interaction);
      sKeys.put("layout/layout_refresh_view_0", com.zxb.secai.R.layout.layout_refresh_view);
      sKeys.put("layout/layout_tag_feed_list_header_0", com.zxb.secai.R.layout.layout_tag_feed_list_header);
      sKeys.put("layout/layout_tag_list_item_0", com.zxb.secai.R.layout.layout_tag_list_item);
    }
  }
}
