...
public class LayoutProfileTabCommentInteractionBindingImpl extends LayoutProfileTabCommentInteractionBinding implements com.zxb.secai.generated.callback.OnClickListener.Listener {
    ...
    private LayoutProfileTabCommentInteractionBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback2 = new com.zxb.secai.generated.callback.OnClickListener(this, 2);
        mCallback1 = new com.zxb.secai.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 2 :
                return onChangeFeedTopCommentUgc((com.zxb.secai.model.Ugc) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeFeedTopCommentUgc(com.zxb.secai.model.Ugc FeedTopCommentUgc, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
    ...
    protected void executeBindings() {
        ...
        com.zxb.secai.model.Ugc feedTopCommentUgc = null;
        ...
        if ((dirtyFlags & 0x4000L) != 0) {
                ...
                stringConvertConvertFeedUgcFeedTopCommentUgcShareCount = com.zxb.secai.utils.StringConvert.convertFeedUgc(feedTopCommentUgcShareCount);
        }
        if ((dirtyFlags & 0x400L) != 0) {

                // read StringConvert.convertFeedUgc(feed.topComment.ugc.likeCount)
                stringConvertConvertFeedUgcFeedTopCommentUgcLikeCount = com.zxb.secai.utils.StringConvert.convertFeedUgc(feedTopCommentUgcLikeCount);
        }
        if ((dirtyFlags & 0x1000L) != 0) {

                // read StringConvert.convertFeedUgc(feed.topComment.ugc.commentCount)
                stringConvertConvertFeedUgcFeedTopCommentUgcCommentCount = com.zxb.secai.utils.StringConvert.convertFeedUgc(feedTopCommentUgcCommentCount);
        }
        ...
        switch(sourceId) {
            ...
            case 1: {
                ...
                if (feedJavaLangObjectNull) {
                    ...
                    com.zxb.secai.ui.InteractionPresenter.toggleCommentLike(lifeCycleOwner, feedTopComment);
                }
                break;
            }
        }
