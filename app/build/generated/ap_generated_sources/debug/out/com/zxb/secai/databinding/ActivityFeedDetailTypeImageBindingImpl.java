...
public class ActivityFeedDetailTypeImageBindingImpl extends ActivityFeedDetailTypeImageBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {3},
            new int[] {com.zxb.secai.R.layout.layout_feed_detail_bottom_inateraction});
    ...
    private ActivityFeedDetailTypeImageBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 3
            ...
            , (com.zxb.secai.databinding.LayoutFeedDetailAuthorInfoBinding) bindings[2]
            , (com.zxb.secai.databinding.LayoutFeedDetailBottomInateractionBinding) bindings[3]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeAuthorInfoLayout((com.zxb.secai.databinding.LayoutFeedDetailAuthorInfoBinding) object, fieldId);
            case 2 :
                return onChangeInteractionLayout((com.zxb.secai.databinding.LayoutFeedDetailBottomInateractionBinding) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeAuthorInfoLayout(com.zxb.secai.databinding.LayoutFeedDetailAuthorInfoBinding AuthorInfoLayout, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    private boolean onChangeInteractionLayout(com.zxb.secai.databinding.LayoutFeedDetailBottomInateractionBinding InteractionLayout, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x8L) != 0) {
            ...
            this.authorInfoLayout.setLeftMargin(com.zxb.libcommon.utils.PixUtils.dp2px(60));
