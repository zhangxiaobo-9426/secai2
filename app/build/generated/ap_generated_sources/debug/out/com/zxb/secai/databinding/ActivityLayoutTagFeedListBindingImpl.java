...
public class ActivityLayoutTagFeedListBindingImpl extends ActivityLayoutTagFeedListBinding implements com.zxb.secai.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {4},
            new int[] {com.zxb.secai.R.layout.layout_refresh_view});
    ...
    // views
    @NonNull
    private final com.zxb.libcommon.view.WindowInsetsFrameLayout mboundView0;
    // variables
    @Nullable
    ...
    private ActivityLayoutTagFeedListBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            ...
            , (com.zxb.secai.databinding.LayoutRefreshViewBinding) bindings[4]
        ...
        this.mboundView0 = (com.zxb.libcommon.view.WindowInsetsFrameLayout) bindings[0];
        ...
        setRootTag(root);
        // listeners
        mCallback9 = new com.zxb.secai.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.owner == variableId) {
            ...
            setTagList((com.zxb.secai.model.TagList) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setTagList(@Nullable com.zxb.secai.model.TagList TagList) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeRefreshLayout((com.zxb.secai.databinding.LayoutRefreshViewBinding) object, fieldId);
            case 1 :
                return onChangeTagList((com.zxb.secai.model.TagList) object, fieldId);
        }
        return false;
    }
    private boolean onChangeRefreshLayout(com.zxb.secai.databinding.LayoutRefreshViewBinding RefreshLayout, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeTagList(com.zxb.secai.model.TagList TagList, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        com.zxb.secai.model.TagList tagList = mTagList;
        ...
        if ((dirtyFlags & 0x12L) != 0) {
            ...
            com.zxb.secai.view.PPImageView.setImageUrl(this.tagLogo, tagListIcon, false, 8);
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        com.zxb.secai.ui.InteractionPresenter.toggleTagLike(owner, tagList);
    }
    // dirty flag
