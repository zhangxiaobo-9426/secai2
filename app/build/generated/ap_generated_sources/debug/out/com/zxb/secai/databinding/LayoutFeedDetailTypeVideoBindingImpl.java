...
public class LayoutFeedDetailTypeVideoBindingImpl extends LayoutFeedDetailTypeVideoBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {1, 2, 3},
            new int[] {com.zxb.secai.R.layout.layout_feed_detail_author_info,
                com.zxb.secai.R.layout.layout_feed_detail_bottom_inateraction,
                com.zxb.secai.R.layout.layout_feed_detail_author_info});
    ...
    private LayoutFeedDetailTypeVideoBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 4
            ...
            , (com.zxb.secai.databinding.LayoutFeedDetailAuthorInfoBinding) bindings[1]
            , (com.zxb.secai.databinding.LayoutFeedDetailBottomInateractionBinding) bindings[2]
            , (androidx.coordinatorlayout.widget.CoordinatorLayout) bindings[0]
            , (com.zxb.secai.databinding.LayoutFeedDetailAuthorInfoBinding) bindings[3]
            , (com.zxb.secai.view.FullScreenPlayerView) bindings[4]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeFullscreenAuthorInfo((com.zxb.secai.databinding.LayoutFeedDetailAuthorInfoBinding) object, fieldId);
            case 1 :
                return onChangeFeed((com.zxb.secai.model.Feed) object, fieldId);
            case 2 :
                return onChangeBottomInteraction((com.zxb.secai.databinding.LayoutFeedDetailBottomInateractionBinding) object, fieldId);
            case 3 :
                return onChangeAuthorInfo((com.zxb.secai.databinding.LayoutFeedDetailAuthorInfoBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeFullscreenAuthorInfo(com.zxb.secai.databinding.LayoutFeedDetailAuthorInfoBinding FullscreenAuthorInfo, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeBottomInteraction(com.zxb.secai.databinding.LayoutFeedDetailBottomInateractionBinding BottomInteraction, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
    ...
    private boolean onChangeAuthorInfo(com.zxb.secai.databinding.LayoutFeedDetailAuthorInfoBinding AuthorInfo, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x20L) != 0) {
            ...
            this.authorInfo.setLeftMargin(com.zxb.libcommon.utils.PixUtils.dp2px(16));
            this.fullscreenAuthorInfo.setLeftMargin(com.zxb.libcommon.utils.PixUtils.dp2px(60));
        }
        if ((dirtyFlags & 0x30L) != 0) {
            // api target 1
