...
public class LayoutFeedTopCommentBindingImpl extends LayoutFeedTopCommentBinding implements com.zxb.secai.generated.callback.OnClickListener.Listener {
    ...
    // views
    @NonNull
    private final com.zxb.libcommon.view.CornerFrameLayout mboundView0;
    @NonNull
    ...
    @NonNull
    private final com.zxb.secai.view.PPImageView mboundView7;
    @NonNull
    ...
    private LayoutFeedTopCommentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 3
            , (com.zxb.secai.view.PPImageView) bindings[1]
            , (android.widget.TextView) bindings[2]
            );
        this.avatar.setTag(null);
        this.mboundView0 = (com.zxb.libcommon.view.CornerFrameLayout) bindings[0];
        ...
        this.mboundView7 = (com.zxb.secai.view.PPImageView) bindings[7];
        ...
        setRootTag(root);
        // listeners
        mCallback6 = new com.zxb.secai.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.lifeCycleOwner == variableId) {
            ...
            setComment((com.zxb.secai.model.Comment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setComment(@Nullable com.zxb.secai.model.Comment Comment) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeComment((com.zxb.secai.model.Comment) object, fieldId);
            case 1 :
                return onChangeCommentUgc((com.zxb.secai.model.Ugc) object, fieldId);
            case 2 :
                return onChangeCommentAuthor((com.zxb.secai.model.User) object, fieldId);
        }
        return false;
    }
    private boolean onChangeComment(com.zxb.secai.model.Comment Comment, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeCommentUgc(com.zxb.secai.model.Ugc CommentUgc, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    private boolean onChangeCommentAuthor(com.zxb.secai.model.User CommentAuthor, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
    ...
    protected void executeBindings() {
        ...
        com.zxb.secai.model.Comment comment = mComment;
        ...
        com.zxb.secai.model.Ugc commentUgc = null;
        ...
        com.zxb.secai.model.User commentAuthor = null;
        ...
        if ((dirtyFlags & 0x80000L) != 0) {
                ...
                stringConvertConvertFeedUgcCommentUgcLikeCount = com.zxb.secai.utils.StringConvert.convertFeedUgc(commentUgcLikeCount);
        }
        ...
        if ((dirtyFlags & 0x25L) != 0) {
            ...
            com.zxb.secai.view.PPImageView.setImageUrl(this.avatar, commentAuthorAvatar, true, (int)0);
        ...
        if ((dirtyFlags & 0x21L) != 0) {
            ...
            com.zxb.secai.view.PPImageView.setImageUrl(this.mboundView7, commentImageUrl, false, (int)0);
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        com.zxb.secai.ui.InteractionPresenter.toggleCommentLike(lifeCycleOwner, comment);
    }
    // dirty flag
