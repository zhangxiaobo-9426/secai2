...
public class LayoutFeedTypeCommentBindingImpl extends LayoutFeedTypeCommentBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {com.zxb.secai.R.layout.layout_feed_author,
                ...
                com.zxb.secai.R.layout.layout_profile_tab_comment_interaction});
        sViewsWithIds = null;
    }
    // views
    @Nullable
    ...
    private LayoutFeedTypeCommentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 4
            ...
            , (com.zxb.secai.databinding.LayoutProfileTabCommentInteractionBinding) bindings[7]
            );
        this.iconCover.setTag(null);
        this.iconVideo.setTag(null);
        this.mboundView0 = (com.zxb.secai.databinding.LayoutFeedAuthorBinding) bindings[4];
        setContainedBinding(this.mboundView0);
        this.mboundView01 = (android.widget.LinearLayout) bindings[0];
        this.mboundView01.setTag(null);
        this.mboundView02 = (com.zxb.secai.databinding.LayoutFeedTextBinding) bindings[5];
        setContainedBinding(this.mboundView02);
        this.mboundView03 = (com.zxb.secai.databinding.LayoutFeedTagBinding) bindings[6];
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 2 :
                return onChangeInteractionBinding((com.zxb.secai.databinding.LayoutProfileTabCommentInteractionBinding) object, fieldId);
            case 3 :
                return onChangeFeedTopCommentAuthor((com.zxb.secai.model.User) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeInteractionBinding(com.zxb.secai.databinding.LayoutProfileTabCommentInteractionBinding InteractionBinding, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
    ...
    private boolean onChangeFeedTopCommentAuthor(com.zxb.secai.model.User FeedTopCommentAuthor, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    protected void executeBindings() {
        ...
        com.zxb.secai.model.User feedTopCommentAuthor = null;
        ...
        if ((dirtyFlags & 0x2bL) != 0) {
            ...
            if ((dirtyFlags & 0x21L) != 0) {
                    ...
                    feedItemTypeFeedTYPEVIDEO = (feedItemType) == (com.zxb.secai.model.Feed.TYPE_VIDEO);
                if((dirtyFlags & 0x21L) != 0) {
        ...
        if ((dirtyFlags & 0x21L) != 0) {
            ...
            com.zxb.secai.view.PPImageView.setImageUrl(this.iconCover, feedCover, (boolean)false, (int)0);
